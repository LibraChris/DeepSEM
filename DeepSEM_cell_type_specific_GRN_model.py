...
class celltype_GRN_model:
    ...
    def train_model(self):
        ...
        vae = VAE_EAD(adj_A_init, 1, self.opt.n_hidden, self.opt.K).float().cpu()
        ...
        for epoch in range(self.opt.n_epochs+1):
            ...
            for i, data_batch in enumerate(dataloader, 0):
                ...
                loss, loss_rec, loss_gauss, loss_cat, dec, y, hidden = vae(inputs,dropout_mask=dropout_mask.cpu(),temperature=temperature,opt=self.opt)
